...
namespace ATM.WinForm.Model
{
    public partial class Model : IModel
    {
        ...
        public ResultadoOperacion ConsultaValor(string sSecuencia, int iTipoVehiculo, bool bMensualidad, bool bReposicion, string Convenios, int TipoTarifa)
        {
            ...
            oResultadoOperacion = _ProxyServicios.ConsultaValor(sSecuencia, iTipoVehiculo,bMensualidad,bReposicion,Convenios,TipoTarifa);
        ...
        public ResultadoOperacion ValidarTransaccion(string IdTarjeta, DateTime FechaEntrada)
        {
            ...
            oResultadoOperacion = _ProxyServicios.ValidarTransaccion(IdTarjeta, FechaEntrada);
        ...
        public ResultadoOperacion RegistrarTiempoGracia(long IdTransaccion)
        {
            ...
            oResultadoOperacion = _ProxyServicios.RegistrarTiempoGracia(IdTransaccion);
        ...
        public ResultadoOperacion ObtenerDatosPlaca(string sLetra1, string sLetra2)
        {
            ResultadoOperacion oResultadoOperacion = new ResultadoOperacion();

            oResultadoOperacion = _ProxyServicios.ObtenerDatosPlaca(sLetra1,sLetra2);
        ...
        public ResultadoOperacion RegistrarPIN(string PIN, int TipoVehiculo, string IdModulo, long IdEstacionamiento, long IdTransaccion)
        {
            ...
            oResultadoOperacion = _ProxyServicios.RegistrarPIN(PIN, TipoVehiculo, IdModulo, IdEstacionamiento, IdTransaccion);
        ...
        public ResultadoOperacion ValidarPIN(long PIN)
        {
            ...
            oResultadoOperacion = _ProxyServicios.ValidarPIN(PIN);
        ...
        public ResultadoOperacion RegistrarPAGOPIN(string PIN, string IdTransaccion, long Secuencia)
        {
            ResultadoOperacion oResultadoOperacion = new ResultadoOperacion();

            oResultadoOperacion = _ProxyServicios.RegistrarPAGOPIN(IdTransaccion,PIN, Secuencia);
        ...
        public ResultadoOperacion RegistrarEvento(string IdTarjeta, long IdTransaccion, long IdEvento)
        {
            ResultadoOperacion oResultadoOperacion = new ResultadoOperacion();

            oResultadoOperacion = _ProxyServicios.RegistrarEvento(IdTransaccion, IdTarjeta, IdEvento);
